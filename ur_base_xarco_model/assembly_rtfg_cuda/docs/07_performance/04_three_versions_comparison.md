...
|------|--------|-----------|------------|-----------|---------|
| 平均时间 | 128 ms | 22.7 ms | 24 μs | 5.6× | **946×** |
| 最小时间 | 45 ms | 8.1 ms | 17 μs | 5.6× | 476× |
| 最大时间 | 350 ms | 65 ms | 80 μs | 5.4× | 813× |
| 稳定性 (σ) | ±52 ms | ±11 ms | ±10 μs | 4.7× | 1100× |

### 批处理 273 目标

| 指标 | MATLAB | C++ (KDL) | CUDA (GPU) | MATLAB→C++ | C++→CUDA |
|------|--------|-----------|------------|-----------|---------|
| 总时间 | ~35 s | 6.2 s | 6.434 ms | 5.6× | **960×** |
| 吞吐量 | 7.8 个/s | 44 个/s | 42,431 个/s | 5.6× | **964×** |
| 迭代次数 | 12.5 avg | 9.2 avg | 6.7 avg | 1.36× | 1.37× |
| 收敛率 | 92.1% | 96.8% | 90.5% | 1.05× | 0.93× |
