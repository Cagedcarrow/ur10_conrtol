...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_share = FindPackageShare("assembly_rtfg_cuda").perform(context)
    ...
    controllers_yaml = PathJoinSubstitution([FindPackageShare("assembly_rtfg_cuda"), "config", "ros2_controllers.yaml"])
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("solver_backend", default_value="cuda"),
        DeclareLaunchArgument(
            "rviz_config",
            default_value=PathJoinSubstitution([FindPackageShare("assembly_rtfg_cuda"), "rviz", "rtfg_view.rviz"]),
        ),
