...
#include "assembly_rtfg_cpp/srv/execute_cached.hpp"
#include "assembly_rtfg_cpp/srv/fit_preview.hpp"
#include "assembly_rtfg_cpp/srv/load_config.hpp"
...
{
public:
  using LoadConfig = assembly_rtfg_cpp::srv::LoadConfig;
  using FitPreview = assembly_rtfg_cpp::srv::FitPreview;
  using ExecuteCached = assembly_rtfg_cpp::srv::ExecuteCached;
  ...
  : Node("rtfg_solver_node")
  {
    ...
    execute_client_ = rclcpp_action::create_client<FollowJT>(
      ...
      controller_action_);
    RCLCPP_INFO(get_logger(), "assembly_rtfg_cpp solver ready: %s", solver_urdf_path_.c_str());
  }
